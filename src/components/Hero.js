...
const Hero = () => {
  return (
    <section className='mx-auto mb-auto xl:mb-44'>
        ...
        <div className="w-full md:w-1/2 lg:w-2/5 xl:w-1/2 flex flex-col justify-start items-start p-5 ml-12">
          <h2
          ...
          <h4 class="ml-2 my-2 text-[24px] text-[#1C048DFF] font-[700] p-3 text-left w-full font-body leading-[36px]">
            Your journey to mental well-being starts here.
            Let's create a happier, healthier you - together!
          </h4>
          <h4 class="ml-2 my-1 text-[22px] font-normal text-[#171A1FFF] p-3 text-left w-full font-body leading-[36px]">
            ...
            <div className='w-full md:w-3/4 lg:w-3/5 xl:w-1/2 flex justify-center items-center md:absolute right-[-5rem] xl:top-[50%] lg:top-[60%] md:top-[30%]'>
                <img src='./images/hero_back.png' alt='hero' className='md:absolute w-full z-[-1]'/>
                <img src='./images/hero.png' alt='mind' className='absolute w-full z-[2]'/>
            </div>
        </div>
    </section>
  )
