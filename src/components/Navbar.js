...
const Navbar = () => {
  ...
  return (
    <section className="my-3" data-scroll-section>
      <div className="md:flex items-center justify-between  md:px-10 px-7 w-full">
        <div class="p-5 flex justify-between items-center">
          <img
            src="./images/nav_logo.jpg"
            class="w-40 md:w-20 cursor-pointer object-cover"
            href="#home"
            alt="nav logo"
            data-scroll-to
          />
        ...
        >
          <ul className="w-full grid md:grid-flow-col gap-4 lg:gap-6 justify-center items-center text-center">
            {Links.map((link) => (
              <li key={link.name}>
                <a
                  href={link.link}
