...
export default function Sidebar({ isSidebarOpen, setIsSidebarOpen }) {
  ...
  return (
    <nav
      className={clsx(
        "z-50 hidden bg-[#f] h-full py-6 lg:flex flex-col transition-all duration-300 ease-in-out",
        isSidebarOpen ? "w-[16%] shadow-md" : "w-[7%] max-w-[100px]",
        isSidebarOpen
...
/>
        ...
        <img
          ...
          alt="Logout"
          className={clsx(
            "w-4 md:w-7 h-auto cursor-pointer transition-transform duration-300 ease-in-out",
            {
